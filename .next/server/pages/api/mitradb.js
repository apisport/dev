...
async function updateMitra(req, res) {
    const { namaVenue , namaPemilikVenue , alamat , noWa , instagram , kategori , hariOperasional , jamOperasional , fasilitas , opsiBayar , rekening , DP , namaAdmin , noWaAdmin , email , fotoVenue , objectId , urlVenue , namaVenueLama  } = req.body;
...
var __webpack_exports__ = __webpack_require__.X(0, [6198], () => (__webpack_exec__(1425)));
